...
### Roadmap
* [х] Настройка инфраструктуры (Docker-compose).
...
1. **Клонируйте репозиторий:**
    ```bash
    git clone <ВАША_ССЫЛКА_НА_GITHUB_РЕПОЗИТОРИЙ>
    cd <название_папки_репозитория>
    ```
2. **Создайте файл .env на основе предоставленного шаблона. В этом файле хранятся доступы к базам данных:**
    ```bash
    cp .env.example .env
    ```
